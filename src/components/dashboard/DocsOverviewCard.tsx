...
const featureDocs = [
  {
    ...
    icon: MessageSquare,
    href: '/help/guide/inbox-conversations',
  },
  {
    title: 'Campaigns',
    summary: 'Send bulk template messages, schedule deliveries, and track performance.',
    icon: Megaphone,
    href: '/help/guide/campaigns-bulk-messaging',
  },
  {
    title: 'Automation & Flows',
    summary: 'Build automated workflows triggered by messages, keywords, or events.',
    icon: Workflow,
    href: '/help/guide/automation-flows',
  },
  {
    title: 'Contacts & Segments',
    summary: 'Organize contacts with tags, segments, and custom attributes.',
    icon: Users,
    href: '/help/guide/contacts-segments',
  },
  {
    title: 'Templates',
    summary: 'Create and submit WhatsApp message templates for Meta approval.',
    icon: BookOpen,
    href: '/help/guide/template-management',
  },
  {
    title: 'Analytics & Reports',
    summary: 'Monitor KPIs, message delivery rates, and agent performance.',
    icon: BarChart3,
    href: '/help/guide/analytics-reporting',
  },
  {
    title: 'AI & Chatbot',
    summary: 'Configure AI-powered auto-replies and chatbot flows for customers.',
    icon: Bot,
    href: '/help/guide/ai-chatbot',
  },
  {
    title: 'Billing & Credits',
    summary: 'Manage your plan, monitor credit usage, and view invoices.',
    icon: CreditCard,
    href: '/help/guide/billing-credits',
  },
];
