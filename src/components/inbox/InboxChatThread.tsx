              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex h-7 w-7 items-center justify-center rounded-md bg-green-500 text-white transition-colors hover:bg-green-600 xl:w-auto xl:px-2 xl:gap-1"
                  >
