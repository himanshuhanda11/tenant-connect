              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-medium bg-green-500 text-white hover:bg-green-600 transition-colors flex-shrink-0"
                  >
