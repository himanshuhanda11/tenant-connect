              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex h-7 w-7 items-center justify-center rounded-md bg-primary text-primary-foreground transition-colors hover:bg-primary/90 xl:w-auto xl:px-2 xl:gap-1"
                  >
                    ...
                    <span className="hidden text-[11px] font-medium xl:inline">WhatsApp</span>
                  </a>
                </TooltipTrigger>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="h-7 text-xs gap-1 text-muted-foreground hover:text-foreground px-2">
                    <ArrowRightLeft className="h-3 w-3" /> <span className="hidden 2xl:inline">Transfer</span>
                  </Button>
                </DropdownMenuTrigger>
