                ...
                <TooltipTrigger asChild>
                  <a
                    href={(() => {
                      ...
                      const templates = [
                        `Hi ${name}! 👋 Thank you for your enquiry about the Europe Work Permit. We are AIReatro Communications — one of the most genuine & registered recruitment companies in Dubai. We'd love to assist you with your dream of working in Europe. How can we help you today?`,
                        `Hello ${name}! 🌍 We received your enquiry regarding the Europe Work Permit program. As a fully registered and trusted recruitment agency based in Dubai, AIReatro is here to guide you every step of the way. Shall we schedule a quick consultation?`,
                        `Dear ${name}, thank you for showing interest in our Europe Work Permit services! 🇪🇺 AIReatro Communications is a licensed recruitment company in Dubai with a proven track record. We'd be happy to discuss the best opportunities available for you.`,
                        `Hi ${name}! 🙌 Great to hear about your interest in working in Europe. AIReatro Communications is among the most trusted & government-registered recruitment firms in Dubai. Let us help you explore the right visa and job options. When is a good time to talk?`,
                        `Hello ${name}! ✈️ Thanks for reaching out about the Europe Work Permit. AIReatro is a fully registered recruitment agency in Dubai, and we specialize in placing candidates across Europe. We'd love to understand your profile and guide you further!`,
                        `Hi ${name}! 🌟 We're excited about your interest in the Europe Work Permit program. AIReatro Communications — a certified and genuine recruitment company in Dubai — has helped hundreds of professionals like you. Let's get started on your journey!`,
                        `Dear ${name}, welcome to AIReatro Communications! 🏢 As a registered recruitment agency in Dubai, we're delighted you've enquired about the Europe Work Permit. Our team will provide you with genuine guidance and transparent processing. How may we assist you?`,
                        `Hi ${name}! 💼 Thank you for your enquiry. AIReatro Communications is a licensed and reputed recruitment firm in Dubai specializing in Europe Work Permits. We believe in 100% transparency and genuine placements. Ready to take the next step?`,
                        `Hello ${name}! 🤝 Your interest in the Europe Work Permit means a lot to us. AIReatro Communications — registered and operating from Dubai — is committed to providing authentic recruitment services. Let's connect and discuss your eligibility!`,
                        `Hi ${name}! 🚀 Welcome aboard! We noticed your enquiry about working in Europe. AIReatro Communications is a government-registered recruitment company in Dubai, and we're here to make your European career dreams a reality. What questions do you have?`,
                      ];
