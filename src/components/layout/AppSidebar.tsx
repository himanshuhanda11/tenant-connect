      ...
      <SidebarMenuItem key={item.title}>
        ...
        {meta && !compact && (
          <Tooltip delayDuration={300}>
            <TooltipTrigger asChild>
              <button className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded opacity-0 group-hover/item:opacity-100 hover:bg-sidebar-accent transition-all">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className={cn(
                ...
                "bg-gradient-to-r from-sidebar-accent to-sidebar-accent/50 hover:from-sidebar-accent/80 hover:to-sidebar-accent/30",
                "border border-sidebar-border hover:border-primary/20",
                isCollapsed ? "p-2 justify-center" : "px-3 py-2.5"
              )}>
                <div className={cn(
                  "flex items-center justify-center rounded-lg font-semibold text-sm flex-shrink-0",
                      ...
                      {currentRole && (
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <div className={cn(
                            ...
                            roleConfig[currentRole]?.bg || "bg-muted"
                          )} />
                          <p className={cn(
                            "text-xs capitalize",
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <Badge 
                        variant="outline" 
                        className={cn(
                          "text-[10px] capitalize mt-1",
                          roleConfig[tenant.role]?.color,
                          roleConfig[tenant.role]?.bg,
                          roleConfig[tenant.role]?.border
                        )}
                      >
                        {tenant.role}
                      </Badge>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" className="w-64 p-2">
            ...
            <DropdownMenuItem 
              ...
              className="gap-3 py-2.5 rounded-lg text-destructive focus:text-destructive focus:bg-destructive/10"
            >
