      ...
      <div className="relative p-5 sm:p-6">
        ...
        <div className="flex items-start gap-4">
          <div className="relative shrink-0">
            <div className={cn(
              "w-14 h-14 rounded-full overflow-hidden flex items-center justify-center text-white shadow-lg ring-4 ring-white",
              !w.logo_url && (isConnected
            ...
            {/* Verified check badge for connected workspaces */}
            {isConnected && (
              <span className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-white flex items-center justify-center shadow-md ring-2 ring-white">
                <CheckCircle2 className="w-5 h-5 text-emerald-500 fill-emerald-500" strokeWidth={2.5} stroke="white" />
              </span>
            )}
          </div>
        ...
        <Button
          ...
          className={cn(
            ...
            "shadow-slate-900/30 hover:shadow-slate-900/50 transition-all"
          )}
        >
