      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 leading-[1.15] text-foreground tracking-tight">
              Simple pricing.{' '}
            ...
            {/* Trust strip */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-5 gap-y-2 text-xs text-muted-foreground mb-5">
            ...
            {/* Billing Toggle */}
            <div className="inline-flex items-center gap-4 px-6 py-3 rounded-2xl bg-card border border-border shadow-sm mb-5">
