...
export function ContactsHeader({
  ...
  return (
    <div className="shrink-0 px-3 sm:px-6 py-3 sm:py-5 border-b bg-gradient-to-r from-background via-background to-muted/30">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        {/* Left: Title */}
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="hidden sm:flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/10">
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={onCreateSegment} className="gap-2 cursor-pointer">
                  <FolderPlus className="h-4 w-4" />
                  Create Segment
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
