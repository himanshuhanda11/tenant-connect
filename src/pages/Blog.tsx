    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-orange-500/15 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-red-500/10 rounded-full blur-[100px]" />
        </div>
        {/* Subtle Grid */}
