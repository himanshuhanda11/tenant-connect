  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[100px]" />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button size="lg" className="h-14 px-8 bg-gradient-to-r from-indigo-500 to-purple-600" onClick={() => navigate('/signup')}>
              Start Integrating
