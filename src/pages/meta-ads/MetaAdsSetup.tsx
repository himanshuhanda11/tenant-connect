...
const REQUIRED_SCOPES = ['ads_read', 'pages_show_list', 'business_management', 'pages_read_engagement', 'leads_retrieval'];
...
export default function MetaAdsSetup() {
  ...
  const handleFbLogin = async () => {
    ...
    try {
      ...
      }, { scope: 'ads_read,pages_show_list,business_management,pages_read_engagement,leads_retrieval', auth_type: 'reauthorize' });
    } catch (err: any) {
