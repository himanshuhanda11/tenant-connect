  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-16 pb-10 md:pt-20 md:pb-14 overflow-hidden bg-gradient-to-b from-background to-muted/30">
        <div className="absolute inset-0"><div className="absolute top-20 left-1/4 w-[400px] h-[400px] bg-indigo-500/5 rounded-full blur-[100px]" /></div>
        <div className="container mx-auto px-4 relative">
          <Breadcrumb className="mb-8" />
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 text-sm font-medium mb-6"><Plug className="w-4 h-4" />Integrations & Webhooks</div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">Connect Your{' '}<span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">Entire Stack</span></h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8">Integrate AiReatro with your favorite tools. Native integrations, powerful API, and real-time webhooks.</p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="h-14 px-8" onClick={() => navigate('/api-docs')}>View API Docs</Button>
              </div>
            </div>
            <div className="w-full max-w-sm lg:max-w-md shrink-0">
              <img src={featureIntegrations} alt="Integration Hub - Connect Your Tools" className="w-full h-auto rounded-2xl" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
