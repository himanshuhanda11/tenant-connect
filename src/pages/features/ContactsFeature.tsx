        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-2xl mb-8">
              Build rich customer profiles, create smart segments, and deliver personalized experiences at scale.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="h-14 px-8 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 shadow-xl shadow-purple-500/25" onClick={() => navigate('/signup')}>
                Start Free Trial
