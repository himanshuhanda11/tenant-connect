    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-violet-500/15 rounded-full blur-[120px]" />
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-2xl mb-8">
              Build, manage, and send WhatsApp message templates with our intuitive template builder. Fast approval, easy management.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="h-14 px-8 bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 shadow-xl shadow-violet-500/25" onClick={() => navigate('/signup')}>
                Start Free Trial
