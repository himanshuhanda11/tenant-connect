...
BEGIN
  ...
  INSERT INTO public.credit_transactions (
    ...
    p_tenant_id, p_amount, v_new_balance, v_tx_type,
...
REVOKE ALL ON FUNCTION public.admin_adjust_message_credits(uuid,integer,text,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.admin_adjust_message_credits(uuid,integer,text,uuid) TO service_role;
